...
class Post(db.Model):
    ...
    date_posted = db.Column(db.DateTime, nullable=False, default=datetime.utcnow()) #default è listante corrente in cui posto
    content = db.Column(db.Text, nullable=False)
    user_id = db.Column(db.Integer, db.ForeignKey('user.id'), nullable=False) #db integer, è una chiave devo specificare la relazione
...
class Event(db.Model):
    ...
    business_id = db.Column(db.Integer, db.ForeignKey('business.id'), nullable=False) #db integer, è una chiave devo specificare la relazione
